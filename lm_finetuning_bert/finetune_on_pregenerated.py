...
class PregeneratedDataset(Dataset):
    ...
    def __getitem__(self, item):
        return (torch.tensor(self.input_ids[item].astype(np.int64), dtype=torch.int64),
                torch.tensor(self.input_masks[item].astype(np.int64), dtype=torch.int64),
                torch.tensor(self.segment_ids[item].astype(np.int64), dtype=torch.int64),
                torch.tensor(self.lm_label_ids[item].astype(np.int64), dtype=torch.int64),
                torch.tensor(self.is_nexts[item].astype(np.int64), dtype=torch.int64))
